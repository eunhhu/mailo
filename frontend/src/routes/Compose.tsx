...
export default function Compose() {
	...
	const [subject, setSubject] = createSignal(
		Array.isArray(paramSubject) ? paramSubject[0] : (paramSubject ?? ""),
	);
	...
	return (
		<>
			<header class="content-header">
				...
				<div class="header-spacer" />
				<button
					class="send-btn header-send-btn"
					onClick={handleSend}
					disabled={sending()}
					aria-label="메일 보내기"
				>
					<Show
						...
						fallback={
							<div
								class="spinner"
								style="width:16px;height:16px;border-color:rgba(255,255,255,0.3);border-top-color:#fff"
							/>
						}
					>
						<svg
			...
			>
				<div class="compose-field">
					<label class="compose-label" for="compose-to">
						받는이
					</label>
					<input
						id="compose-to"
				...
				<div class="compose-field">
					<label class="compose-label" for="compose-subject">
						제목
					</label>
					<input
						id="compose-subject"

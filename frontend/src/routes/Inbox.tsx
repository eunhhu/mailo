		...
		<>
			...
			<Show when={selectMode()}>
				<div class="batch-toolbar">
					...
					<button onClick={exitSelectMode} aria-label="선택 취소">
						취소
					</button>
				</div>
			</Show>
							...
							{(email, i) => (
								...
								>
									<div class="email-row-wrapper">
										...
										<Show when={(swipeOffset()[email.id] || 0) < 0}>
											<div class="swipe-bg delete" aria-hidden="true">
												{swipeLeftLabel()}
											</div>
										</Show>
										<div
													...
													<div class="email-row-actions">
														...
														<Show when={showStarAction()}>
															<button
																...
																onClick={(e) =>
																	handleRowStar(e, email.id, email.labelIds?.includes("STARRED"))
																}
																aria-label={
																	email.labelIds?.includes("STARRED") ? "별표 해제" : "별표"
																}
															>
																<svg
																	width="15"
																	...
																	viewBox="0 0 24 24"
																	fill={
																		email.labelIds?.includes("STARRED") ? "currentColor" : "none"
																	}
																	stroke="currentColor"
																	stroke-width="2"
																	stroke-linecap="round"
